...
/*    Anzeigen von gleichrangigen Kategorien HTML5 Template
/*	
/************************************************************/
...
if ( JFile::exists($file) == true ) {
	...
	include(JPATH_SITE.DS.'components'.DS.'com_flexicontent'.DS.'tmpl_common'.DS.'category_peercategories_html5.php');
}
