...
STYLE;
		...
		switch ($params->get("filterlayout", "vt")) {
			...
			case "ful":
				?>
				<ul class="d-md-flex flex-wrap wbc-jevlist" >
					<?php
					$hasreset = false;
					foreach ($filterHTML as $filter)
					{
						...
						<li>
							...
							?>
							<div class="jevfilterinput form-group">
					...
					?>
					<li>
						<div class="jevfilterinput form-group buttons">
						<input class="btn btn-outline-secondary mr-2" type="button" onclick="JeventsFilters.reset(this.form)" value="<?php echo JText::_('RESET'); ?>" />
						
						<input class="btn btn-secondary" type="submit" value="<?php echo JText::_('ok'); ?>" name="jevents_filter_submit" />
						</div>
					</li>
				</ul>
				<?php
