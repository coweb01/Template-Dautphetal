...
<div class="<?php echo $panel; ?> <?php echo $panel_hover; ?> {wk}-text-<?php echo $settings['text_align']; ?>">
    ...
    <a class="{wk}-position-cover {wk}-position-z-index" href="<?php echo $item->escape('link'); ?>"<?php echo $link_target; ?> title="<?php echo $item->escape('link'); ?>"></a>
    <?php endif; ?>
    ...
    <p><a<?php if($link_style) echo ' class="readon ' . $link_style . '"'; ?> href="<?php echo $item->escape('link'); ?>" target="_blank"<?php echo $link_target; ?>><?php echo $app['translator']->trans($settings['link_text']); ?></a></p>
    <?php endif; ?>
